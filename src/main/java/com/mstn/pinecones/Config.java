...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue REPLACE_SAPLING_DROPS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue PINECONE_REPLANT_CHANCE = BUILDER
    ...
    public static final ModConfigSpec.IntValue PINECONE_TREE_SPACING = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLANT_DELAY_TICKS = BUILDER
    ...
    public static final ModConfigSpec.IntValue BEE_NEST_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue BEE_PINECONE_DROP_TIMEOUT_TICKS = BUILDER
    ...
    public static final ModConfigSpec.IntValue BEE_MIN_PINECONE_DROP_DISTANCE = BUILDER
    ...
    public static final ModConfigSpec.IntValue BEE_PINECONE_SEARCH_RADIUS = BUILDER
            .comment("Radius in which bees search for pinecones on the ground")
            .defineInRange("beePineconeSearchRadius", 10, 1, 32);

    public static final ModConfigSpec.IntValue BEE_POLLEN_SEARCH_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue COLONY_EXPANSION_ENABLED = BUILDER
    ...
    public static final ModConfigSpec.IntValue COLONY_EXPANSION_FLOWER_COUNT = BUILDER
    ...
    public static final ModConfigSpec.IntValue COLONY_EXPANSION_FLOWER_RADIUS = BUILDER
            .comment("Radius to search for flowers around the bee nest")
            .defineInRange("colonyExpansionFlowerRadius", 8, 1, 32);

    public static final ModConfigSpec.IntValue COLONY_EXPANSION_HOSTILE_CHECK_RADIUS = BUILDER
            .comment("Radius around colony expansion to check for hostile mobs")
            .defineInRange("colonyExpansionHostileCheckRadius", 16, 1, 64);

    public static final ModConfigSpec.IntValue COLONY_EXPANSION_SPAWN_COUNT = BUILDER
    ...
    public static final ModConfigSpec.IntValue COLONY_EXPANSION_MAX_SPAWNED_BEES = BUILDER
    ...
    public static final ModConfigSpec.IntValue COLONY_EXPANSION_HOSTILE_CHECK_INTERVAL = BUILDER
            .comment("Ticks between hostile mob checks (20 = 1 second)")
            .defineInRange("colonyExpansionHostileCheckInterval", 40, 10, 200);

    public static final ModConfigSpec.IntValue COLONY_EXPANSION_AGGRO_DURATION = BUILDER
    ...
    public static final ModConfigSpec.IntValue COLONY_EXPANSION_AGGRO_RADIUS = BUILDER
            .comment("Radius around colony expansion to check for aggro'd player")
            .defineInRange("colonyExpansionAggroRadius", 16, 4, 32);

    public static final ModConfigSpec.IntValue BEE_MAX_POPULATION = BUILDER
    ...
    public static final ModConfigSpec.IntValue BEES_PER_NEST = BUILDER
